...
You can download Clash core binaries here: [https://github.com/pfugwtg/clash-core/releases](https://github.com/pfugwtg/clash-core/releases)
...
For other build targets, check out the [Makefile](https://github.com/pfugwtg/clash-core/blob/master/Makefile).
